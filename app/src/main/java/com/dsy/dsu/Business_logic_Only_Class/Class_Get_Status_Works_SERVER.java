...
/////////////////////////
                    ...
                    new   Class_Generation_Errors(contextДляПолучениеСтатусаСервераДванныеНаНемЕстьИлиНет).МетодЗаписиВЖурналНовойОшибки(ex.toString(), MODEL_synchronized.class.getName(),
