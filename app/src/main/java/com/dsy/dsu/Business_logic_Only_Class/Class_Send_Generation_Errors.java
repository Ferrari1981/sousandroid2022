...
///
        ...
        new Class_Sendiing_Errors(contextДляКлассаПосылаемОшибкиНАСервер).
                МетодПослываемОшибкиАдминистаторуПо(БуферОшибкаПриПодключениекСерверуДляАунтификацииПользователяПриВходе,activity);
