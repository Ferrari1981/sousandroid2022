...
// TODO: 11.03.2022
    ...
    private void МетодгенерируемВходящиеДанныеЧтоБЫПрередатьИхДаллеВдругиеАктивтиЛистЧат() throws ExecutionException, InterruptedException {
        ...
        if (ХэщЗапусАктивтиИзФрагмента!=null) {
            ...
            Log.d(this.getClass().getName(), "Class_Generation_SendBroadcastReceiver_And_Firebase_OneSignal ХэщЗапусАктивтиИзФрагмента "+ХэщЗапусАктивтиИзФрагмента.keySet().toArray());
            ////
